    ...
    <StudentDashboardLayout>
      <div className="space-y-10 pb-20">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
                { label: 'Problems Solved', value: '142', icon: CheckCircle2, color: 'text-emerald-500' },
                { label: 'Current Streak', value: '12 Days', icon: Zap, color: 'text-amber-500' },
                { label: 'Study Hours', value: '48.5h', icon: Clock, color: 'text-blue-500' },
                { label: 'Accuracy', value: '76%', icon: Star, color: 'text-purple-500' }
            ].map((stat, i) => (
                <motion.div
                    key={i}
                    initial={{ opacity: 0, y: 10 }}
