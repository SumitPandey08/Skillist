      ...
      <StudentDashboardLayout>
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center space-y-4">
            <h2 className="text-2xl font-black">Sync Error</h2>
            <p className="text-muted-foreground">We couldn't connect to your AI ecosystem.</p>
            <Link href="/onboarding">
               <button className="px-6 py-2 bg-primary text-white rounded-full font-bold">Restart Onboarding</button>
            </Link>
          </div>
        </div>
      </StudentDashboardLayout>
